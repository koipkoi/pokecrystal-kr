; name lengths
NAME_LENGTH          EQU 11
PLAYER_NAME_LENGTH   EQU 11
BOX_NAME_LENGTH      EQU 17
MON_NAME_LENGTH      EQU 11
MOVE_NAME_LENGTH     EQU 15
ITEM_NAME_LENGTH     EQU 18
TRAINER_CLASS_NAME_LENGTH EQU 18
...
; 폰트 속성 (see home/text.asm)
FONT_DEFAULT EQU 0 ; xor a로 사용
FONT_INVERSE EQU 1
FONT_FILL_BG EQU 2
